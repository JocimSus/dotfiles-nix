{
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kcm_touchpad"."Toggle Touchpad" = ["Touchpad Toggle" "Meta+Ctrl+Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku,Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku"];
      ...
      "org_kde_powerdevil"."powerProfile" = ["Meta+B" "Battery" "Tools,Battery" "Meta+B,Switch Power Profile"];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,3,3,21,5,26.066";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."2e75d2bb-648f-4569-9a21-71f47b134971" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "2e75d2bb-648f-4569-9a21-71f47b134971";
      ...
      "kcminputrc"."Libinput/1133/50498/Logitech Wireless Receiver Mouse"."PointerAcceleration" = 0.000;
      "kcminputrc"."Libinput/1133/50498/Logitech Wireless Receiver Mouse"."PointerAccelerationProfile" = 1;
      "kcminputrc"."Libinput/1267/12930/ELAN0307:00 04F3:3282 Touchpad"."Enabled" = false;
      "kcminputrc"."Libinput/1267/12930/ELAN0307:00 04F3:3282 Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Libinput/1267/12930/ELAN0307:00 04F3:3282 Touchpad"."ScrollFactor" = 0.1;
      ...
      "kwinrc"."Desktops"."Id_1" = "3ec405eb-a557-4f4d-ac83-8d423f0660a3";
      ...
      "kwinrc"."Tiling/82fa6e03-2eef-51c7-87ad-688ceeb16eca"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/jocim-nix/.dotfiles/flake.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/jocim-nix/.dotfiles/home.nix";
      "kate/anonymous.katesession"."Document 2"."URL" = "file:///home/jocim-nix/.dotfiles/configuration.nix";
      "kate/anonymous.katesession"."Document 3"."URL" = "file:///home/jocim-nix/.dotfiles/plasma6.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,914,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 508;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 508;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 597;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,508,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 508;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = 3;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 4;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "0,1,2,3";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 48;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 20;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorColumn" = 22;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorLine" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorColumn" = 11;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorLine" = 7;
